...
public final class CustomAwardDataHelper {
	 ...
	 */
	boolean isArra() {
		return "Yes".equals(((AwardExtension) award.getExtension())
				.getArraCode());
	}
	...
	boolean isFringeNotAllowed() {
		return ((AwardExtension) award.getExtension())
				.getFringeNotAllowedIndicator();
	}
	...
	Date getLastTransmissionDate() {
		Date date = ((AwardExtension) award.getExtension())
				.getLastTransmissionDate();
		if (date != null) {
