...
import edu.ku.kuali.kra.award.printing.BUAwardNoticePrint;
...
public class AwardPrintingServiceImpl extends org.kuali.kra.award.printing.service.impl.AwardPrintingServiceImpl {
    ...
    /**
     * This method generates the required report and returns the PDF stream as {@link AttachmentDataSource}. It first identifies the report type to be
     ...
     */
    public AttachmentDataSource printAwardReport(KcPersistableBusinessObjectBase printableBO, AwardPrintType awardReportType,
    ...
    protected String getReportName(String reportFileNamePrefix, String reportName) {
        ...
        StringBuilder reportFullName = new StringBuilder(reportFileNamePrefix).append("_").append(reportName.replace(' ', '_'))
                .append(Constants.PDF_FILE_EXTENSION);
