...
/**
 * This class represents the Struts Action for Special Review
 * page(AwardSpecialReview.jsp).
 */
public class AwardSpecialReviewAction extends org.kuali.kra.award.web.struts.action.AwardSpecialReviewAction {
