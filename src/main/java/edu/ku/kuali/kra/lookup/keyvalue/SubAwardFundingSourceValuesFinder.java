    ...
    public List<KeyValue> getKeyValues() {
        ...
        for (SubAwardFundingSource subAwardFunding : fundingSource) {
            if (subAwardFunding.getSubAwardId().equals(subawardID)) {
                ...
                keyValues.add(new ConcreteKeyValue(subAwardFunding.getSubAwardFundingSourceId().toString(), "Award:"
                        + subAwardFunding.getAward().getAwardNumber() + " Ver. " + subAwardFunding.getAward().getSequenceNumber()));
            }
        }
