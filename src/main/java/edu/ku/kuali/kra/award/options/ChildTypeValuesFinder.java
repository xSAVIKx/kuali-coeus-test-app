...
/**
 * BUKC-0002: Child Type field on Award Module under Award Tab on Panel
 * Detail&dates under sub panel Institution.
 */
public class ChildTypeValuesFinder extends UifKeyValuesFinderBase {
    ...
    public List<KeyValue> getKeyValues() {
        ...
        keyValues.add(2, new ConcreteKeyValue("Participant Support", "Participant Support"));
        keyValues.add(3, new ConcreteKeyValue("Costs", "Costs"));
        keyValues.add(4, new ConcreteKeyValue("Fabricated Equipment", "Fabricated Equipment"));
        keyValues.add(5, new ConcreteKeyValue("Group", "Group"));

        // BUKC-0113: Add new Child Types: Subaward, Cost Sharing, and Program
        // Income (ENHC0012536)
