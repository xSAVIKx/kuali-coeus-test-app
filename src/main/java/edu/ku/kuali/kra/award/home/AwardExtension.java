...
package edu.ku.kuali.kra.award.home;
 ...
 */
public class AwardExtension extends KcPersistableBusinessObjectBase implements PersistableBusinessObjectExtension {
    ...
    // BUKC-0167: Award: request that a Federal Clinical Trial field be added to
    // the KC awards module (ENHC0013482)
    ...
    public void setProposedForTransmissionIndicator(String proposedForTransmissionIndicator) {
    ...
    public void setInterestEarnedAccountNumber(String interestEarnedAccountNumber) {
    ...
    public void setClinicalTrialRegistrationDate(Date clinicalTrialRegistrationDate) {
